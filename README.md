# Киоск самообслуживания — Java

Desktop-приложение в подстроенный под терминалы самообслуживания (по типу киоски в kfc и ЦОН).

## Требования

- **Java 17+** (я использовал 23)
- **Maven 3.8+**
- **IntelliJ IDEA** 2023+ (Community или Ultimate)
- API Emulator запущен на `http://localhost:7924` (он есть в отдельном репозитории)
...
Нужно зарание запустить API Emulator на `http://localhost:7924` перед запуском приложения.
